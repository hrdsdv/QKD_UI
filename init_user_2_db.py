...
def init_db():
    ...
    db_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), 'server_user_2', 'databases'))
    os.makedirs(db_dir, exist_ok=True)

    # Используем абсолютный путь к файлу базы данных
    db_path = os.path.join(db_dir, 'user_2_db.db')
    ...
    # Абонент А (для приёма сообщений)
    cursor.execute('''
