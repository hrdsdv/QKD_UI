...
def init_admin():
    """Добавляет администратора в базу данных, если его там нет."""
    try:
        admin = db_manager.get_user_by_username('Admin')
        if not admin:
            db_manager.register_user('Admin', 'Admin', '000000000', 'Admin', '12345678qkd', 'admin')
            print("Администратор добавлен в базу данных.")
